...
insert into service_review(title, comment, id_optional_service, id_customer,star_rating, created_at)
values ('title1', 'comment1', 1, 9, 3, (select current_timestamp)),
       ('title2', 'comment2', 2, 10, 3, (select current_timestamp)),
       ('title3', 'comment3', 3, 11, 2, (select current_timestamp)),
       ('title4', 'comment4', 4, 12, 1, (select current_timestamp)),
       ('title5', 'comment5', 5, 13, 5, (select current_timestamp)),
       ('title6', 'comment6', 6, 9, 3, (select current_timestamp)),
       ('title7', 'comment7', 7, 10, 2, (select current_timestamp)),
       ('title8', 'comment8', 8, 11, 4, (select current_timestamp)),
       ('title9', 'comment9', 9, 12, 5, (select current_timestamp)),
       ('title10', 'comment10', 10, 13, 4, (select current_timestamp));
...
INSERT INTO location_review (title, comment, id_location,  id_customer,star_rating, created_at)
VALUES ('False advertisement', 'Location was alright but it simply was not as big as advertised.', 1, 9, 2,
        (select current_timestamp)),
       ('Great place!', 'I cannot recommend it enough. I love it, will come again.', 2, 10, 5, (select current_timestamp)),
       ('Horrible shack.', 'Location was alright but not fit to my tastes.', 3, 11, 2, (select current_timestamp)),
       ('It was so-so', 'It was ok, but not great.', 4, 12, 3, (select current_timestamp)),
       ('Just perfect.', 'Clean, spacious and with great customer service. You will not be dissapointed!', 5, 13,5,
        (select current_timestamp));
