...
public class SecurityService {
    ...
    public void buildSecurityContext(LoginRequest loginRequest, HttpServletRequest request) {
        ...
        boolean isNew = isNewAccount(user.getId());
    ...
    private boolean isNewAccount(Long id) {
        return !businessRepository.existsByUser_Id(id) && !customerRepository.existsByUser_Id(id);
    }
